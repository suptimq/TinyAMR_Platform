...
SOFTPWM_DEFINE_PIN42_CHANNEL(0);  //Configure Arduino pin 13 as PWM channel 0
SOFTPWM_DEFINE_PIN46_CHANNEL(1);  //Configure Arduino pin 13 as PWM channel 0
